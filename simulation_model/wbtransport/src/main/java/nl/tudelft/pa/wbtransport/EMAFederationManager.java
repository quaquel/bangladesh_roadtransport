...
public class EMAFederationManager
{
    ...
    private void startModel(final String federationName, final int fsPort, final String localSk3) throws Sim0MQException
    {
        ...
        {
            fm1Message = SimulationMessage.encode(federationName, "FM", "FS", "FM.1", ++this.messageCount, MessageStatus.NEW,
                    "BGD1.1", "java8+", "-jar", "E:/BGD/bgd.jar", "BGD1.1 %PORT% E:/BGD/", "E:/BGD", "", "E:/BGD/out.txt",
                    "E:/BGD/err.txt", false, false, false);
    ...
    private void setParameters(final String federationName) throws Sim0MQException
    {
        ...
        for (String product : new String[] { "Textile", "Garment", "Steel", "Brick", "Food" })
        {
            ...
            {
                parameters.put(product + "_" + param, new Double(1.1));
            }
        }
        
        for (String product : new String[] { "Textile", "Garment", "Steel", "Brick", "Food" })
        {
            parameters.put(product + "_road", new Double(0.8));
            parameters.put(product + "_rail", new Double(0.0));
            parameters.put(product + "_water", new Double(0.2));
        }
        
        parameters.put("Damage_road_n", new Double(0.2));
        parameters.put("Damage_road_r", new Double(0.2));
        parameters.put("Damage_road_z", new Double(0.2));
        parameters.put("Damage_ferry", new Double(0.2));
        parameters.put("Damage_bridge_a", new Double(0.2));
        parameters.put("Damage_bridge_b", new Double(0.2));
        parameters.put("Damage_bridge_c", new Double(0.2));
        parameters.put("Damage_bridge_d", new Double(0.2));
        parameters.put("Damage_waterway_1", new Double(0.2));
        parameters.put("Damage_waterway_2", new Double(0.2));
        parameters.put("Damage_waterway_3", new Double(0.2));
        parameters.put("Damage_waterway_4", new Double(0.2));
        parameters.put("Damage_ports", new Double(0.2));
        parameters.put("Damage_terminals", new Double(0.2));
        parameters.put("Damage_railways", new Double(0.2));
        parameters.put("Damage_railstations", new Double(0.2));
