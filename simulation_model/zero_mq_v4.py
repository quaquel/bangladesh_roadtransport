...
class ZeroMQModel(Replicator, AbstractModel):
    ...
    def __init__(self, name, softwareCode, argsBefore, fullPathModelFile, 
        ...
        self.receiver = argsAfter.split()[0]
    ...
    def SimRunControl(self):
        ...
        payload.append(len(self.replications)) # TODO:: 
        payload.append(0)
    ...
    @method_logger   
    def prepare_message(self, run_id=None, receiver=None, type=None, 
                        status=None, payload=[]):
        content = []
